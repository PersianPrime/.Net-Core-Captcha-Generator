    ...
    public static CaptchaResult GenerateCaptchaImage(int width, int height, string captchaCode)
    {
        ...
        using (Graphics graph = Graphics.FromImage(baseMap))
        {
            ...
            void AdjustRippleEffect()
            {
                ...
                System.Drawing.Imaging.BitmapData bitmapData = baseMap.LockBits(new Rectangle(0, 0, baseMap.Width, baseMap.Height), ImageLockMode.ReadWrite, PixelFormat.Format24bppRgb);
